...
public:
    ...
    void mem_void_copiable(Copiable nc) { _message = nc._message; std::cout << _message << " mem_void_copiable" << std::endl; };
    void mem_void_const_copiable(const Copiable nc) { _message = nc._message; std::cout << _message << " mem_void_const_copiable" << std::endl; };
    ...
    void mem_void_copiable_ref(Copiable& nc) { _message = nc._message; std::cout << _message << " mem_void_copiable_ref" << std::endl; };
    void mem_void_const_copiable_ref(const Copiable& nc) { _message = nc._message; std::cout << _message << " mem_void_const_copiable_ref" << std::endl; };
    ...
    void mem_void_copiable_rvalue_ref(Copiable&& nc) { _message = nc._message; std::cout << _message << " mem_void_copiable_rvalue_ref" << std::endl; };
    void mem_void_const_copiable_rvalue_ref(const Copiable&& nc) { _message = nc._message; std::cout << _message << " mem_void_const_copiable_rvalue_ref" << std::endl; };
